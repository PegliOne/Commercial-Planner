...
d4 = Department.create :name => "Ministry of Transport", :head_quarters => "Moscow", :email => "transport@soviet.org", :contact_number => "9599 5559"
d5 = Department.create :name => "Ministry of Culture", :head_quarters => "Saint Petersburg", :email => "education@soviet.org", :contact_number => "9555 1234"
puts "#{ Department.count } departments"

Shift.destroy_all
s1 = Shift.create :location => "Western Siberia", :role => "Harvesting Grain", :hours => 8, :start_time => "05-04-2021 06:00:00"
s2 = Shift.create :location => "Kazakstan", :role => "Harvesting Grain", :hours => 8, :start_time => "06-04-2021 06:00:00"
s3 = Shift.create :location => "Western Siberia", :role => "Harvesting Fruit", :hours => 8, :start_time => "07-04-2021 06:00:00"
