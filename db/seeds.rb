...
Order.destroy_all
o1 = Order.create :date => "04-04-2021", :address => "43 Spencer Street, Melbourne"
o2 = Order.create :date => "05-04-2021", :address => "61 Flinders Street, Melbourn"
o3 = Order.create :date => "04-04-2021", :address => "17 George Street, Sydney"
o4 = Order.create :date => "05-04-2021", :address => "66 Oxford Street, Sydney"
o5 = Order.create :date => "06-04-2021", :address => "77 Elizabeth Street, Melbourne"
...
Shift.destroy_all
s1 = Shift.create :location => "Melbourne", :role => "Stock Filling (Dining)", :hours => 8, :start_time => "05-04-2021 06:00:00"
s2 = Shift.create :location => "Sydney", :role => "Stock Filling (Bath)", :hours => 8, :start_time => "06-04-2021 06:00:00"
s3 = Shift.create :location => "Melbourne", :role => "Customer Service (Dining)", :hours => 8, :start_time => "07-04-2021 08:00:00"
s4 = Shift.create :location => "Sydney", :role => "Customer Service (Bath)", :hours => 8, :start_time => "07-04-2021 08:00:00"
s5 = Shift.create :location => "Melbourne", :role => "Stock Filling (Electrical)", :hours => 8, :start_time => "09-04-2021 07:00:00"
s6 = Shift.create :location => "Sydney", :role => "Stock Filling (Electrical)", :hours => 8, :start_time => "08-04-2021 07:00:00"
s7 = Shift.create :location => "Melbourne", :role => "Customer Service (Electrical)", :hours => 6, :start_time => "05-04-2021 09:00:00"
s8 = Shift.create :location => "Sydney", :role => "Customer Service (Electrical)", :hours => 6, :start_time => "06-04-2021 09:00:00"
s9 = Shift.create :location => "Melbourne", :role => "Stock Filling (Clothing)", :hours => 8, :start_time => "08-04-2021 06:00:00"
s10 = Shift.create :location => "Sydney", :role => "Stock Filling (Clothing)", :hours => 8, :start_time => "08-04-2021 06:00:00"
s11 = Shift.create :location => "Melbourne", :role => "Customer Service (Clothing)", :hours => 6, :start_time => "05-04-2021 13:00:00"
s12 = Shift.create :location => "Sydney", :role => "Customer Service (Clothing)", :hours => 6, :start_time => "05-04-2021 13:00:00"
s13 = Shift.create :location => "Melbourne", :role => "Stock Filling (Body)", :hours => 8, :start_time => "06-04-2021 07:00:00"
s14 = Shift.create :location => "Sydney", :role => "Stock Filling (Body)", :hours => 8, :start_time => "10-04-2021 07:00:00"
s15 = Shift.create :location => "Melbourne", :role => "Customer Service (Body)", :hours => 6, :start_time => "05-04-2021 13:00:00"
s16 = Shift.create :location => "Sydney", :role => "Customer Service (Body)", :hours => 6, :start_time => "05-04-2021 13:00:00"
s17 = Shift.create :location => "Melbourne", :role => "Stock Filling (Kids)", :hours => 8, :start_time => "10-04-2021 06:00:00"
s18 = Shift.create :location => "Sydney", :role => "Stock Filling (Kids)", :hours => 8, :start_time => "09-04-2021 06:00:00"
s19 = Shift.create :location => "Melbourne", :role => "Customer Service (Kids)", :hours => 5, :start_time => "09-04-2021 15:00:00"
s20 = Shift.create :location => "Sydney", :role => "Customer Service (Kids)", :hours => 5, :start_time => "09-04-2021 15:00:00"
